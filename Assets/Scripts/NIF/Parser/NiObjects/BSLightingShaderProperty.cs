...
namespace NIF.Parser.NiObjects
{
    ...
    public class BsLightingShaderProperty : BsShaderProperty
    {
        ...
        //FO4 and 76 wetness and luminance params are skipped coz I'm lazy
        ...
        private BsLightingShaderProperty(BsShaderProperty ancestor) : base(ancestor.ShaderType, ancestor.Name,
        ...
        public new static BsLightingShaderProperty Parse(BinaryReader nifReader, string ownerObjectName, Header header)
        {
            ...
            var bsShaderProperty = new BsLightingShaderProperty(ancestor);
